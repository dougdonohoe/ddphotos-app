...
public class CommandLine
{
    ...
    /**
     * Return Option for given name; null if non-existent
     */
    ...
    /**
     * Return Option for given name; create new if non-existent
     */
    ...
    /**
     * Return Option for given name; create new if non-existent and
     * bCreate passed
     */
    ...
    /**
     * Specify minimum number of non-optioned command line arguments are
    ...
    /**
     * Specify maximum number of non-optioned command line arguments are
     * required.  Typically used for commands which take
    ...
    /**
     * Add a double option, with default value
     */
    ...
    public static void parseArgs(String[] args)
    {
        ...
        while (iter.hasNext())
        {
            ...
            if (value == null)
            {
                ...
                {
                    if (sRequired == null)
                        sRequired = new StringBuilder(o.sName);
                    else
                        sRequired.append(' ').append(o.sName);
                }
