...
public class LoggingConfig
{
    ...
    public void init()
    {
        ...
        String configStub = switch (type) {
            case CLIENT, HEADLESS_CLIENT -> "log4j2.client";
            case COMMAND_LINE -> "log4j2.cmdline";
        };
        ...
        {
            // determine log dir
            File parentdir = runtimeDirectory.getClientHome(appName);
