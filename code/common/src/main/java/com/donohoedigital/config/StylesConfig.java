...
public class StylesConfig extends XMLConfigFileLoader
{
    ...
    public static String getRGB(String sName) {
        Color c = getColor(sName, StylesConfig.USE_DEFAULT_COLOR);
        if (c == null) { return ""; }
    ...
    public static Color getColor(String sName, Color cDefault)
    {
        ...
        if (c == StylesConfig.USE_DEFAULT_COLOR) {
            return cDefault;
        }
    ...
    private void initColor(Element color, String sAttrErrorDesc) throws ApplicationError
    {
        ...
        Boolean bDefault = getBooleanAttributeValue(color, "default", false, sAttrErrorDesc);

        // if default=true, just use default color for widget, as based on Swing L&F
        if (bDefault != null && bDefault) {
            ApplicationError.assertTrue(a == null, "'a' should not be defined in color entry " + sName + " (default)");
            ApplicationError.assertTrue(r == null, "'r' should not be defined in color entry " + sName + " (default)");
            ApplicationError.assertTrue(g == null, "'g' should not be defined in color entry " + sName + " (default)");
            ApplicationError.assertTrue(b == null, "'b' should not be defined in color entry " + sName + " (default)");
            ApplicationError.assertTrue(sCopy == null, "'copy' should not be defined in color entry " + sName + " (default)");
            colors_.put(sName, USE_DEFAULT_COLOR);
        }
        else if (sCopy != null)
        {
