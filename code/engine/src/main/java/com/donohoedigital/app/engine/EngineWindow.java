...
public class EngineWindow extends BaseFrame {
    ...
    private final AppEngine engine_;
     ...
     * Constructor
     */
    public EngineWindow(AppEngine engine, AppContext context, String sName, int nDesiredMinWidth, int nDesiredMinHeight) {
        super();
        engine_ = engine;
        context_ = context;
        setName(sName);
     ...
     */
    public void init(AppPhase phase, boolean bMain, Dimension size, String sTitle, boolean bResizable) {
        // create base panel and setup frame
        base_ = new EngineBasePanel(this, phase);
        ...
        if (!Utils.ISMAC) {
            GuiUtils.addKeyAction(base_, JComponent.WHEN_IN_FOCUSED_WINDOW,
                    "appengineclose", bMain ? quit : close,
